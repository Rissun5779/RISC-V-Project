...
module e203_exu_oitf (
  ...
  // output the hazard signal of the registers a0 ~ a7.
  output oitfrd_match_dispa0,
  output oitfrd_match_dispa1,
  output oitfrd_match_dispa2,
  output oitfrd_match_dispa3,
  output oitfrd_match_dispa4,
  output oitfrd_match_dispa5,
  output oitfrd_match_dispa6,
  output oitfrd_match_dispa7,
 ...
 assign dis_ready = (~oitf_full);
  ...
  // NTUST CUSTOM DOT START
  // record all instructions in oitf whether have the hazard with the registers a0 ~ a7. 
  wire [`E203_OITF_DEPTH-1:0] rd_match_a0; 
  wire [`E203_OITF_DEPTH-1:0] rd_match_a1; 
  wire [`E203_OITF_DEPTH-1:0] rd_match_a2; 
  wire [`E203_OITF_DEPTH-1:0] rd_match_a3; 
  wire [`E203_OITF_DEPTH-1:0] rd_match_a4; 
  wire [`E203_OITF_DEPTH-1:0] rd_match_a5; 
  wire [`E203_OITF_DEPTH-1:0] rd_match_a6; 
  wire [`E203_OITF_DEPTH-1:0] rd_match_a7; 
  // NTUST CUSTOM DOT END
  genvar i;
  generate //{
      for (i=0; i<`E203_OITF_DEPTH; i=i+1) begin:oitf_entries//{
        ...
        // NTUST CUSTOM DOT START
		// the instructions in oitf match the registers a0 ~ a7.
		assign rd_match_a0[i] = vld_r[i] & rdwen_r[i] & (rdidx_r[i] == `E203_RFIDX_WIDTH'b01010);
		assign rd_match_a1[i] = vld_r[i] & rdwen_r[i] & (rdidx_r[i] == `E203_RFIDX_WIDTH'b01011);
		assign rd_match_a2[i] = vld_r[i] & rdwen_r[i] & (rdidx_r[i] == `E203_RFIDX_WIDTH'b01100);
		assign rd_match_a3[i] = vld_r[i] & rdwen_r[i] & (rdidx_r[i] == `E203_RFIDX_WIDTH'b01101);
		assign rd_match_a4[i] = vld_r[i] & rdwen_r[i] & (rdidx_r[i] == `E203_RFIDX_WIDTH'b01110);
		assign rd_match_a5[i] = vld_r[i] & rdwen_r[i] & (rdidx_r[i] == `E203_RFIDX_WIDTH'b01111);
		assign rd_match_a6[i] = vld_r[i] & rdwen_r[i] & (rdidx_r[i] == `E203_RFIDX_WIDTH'b10000);
		assign rd_match_a7[i] = vld_r[i] & rdwen_r[i] & (rdidx_r[i] == `E203_RFIDX_WIDTH'b10001);
		// NTUST CUSTOM DOT END
      end//}
  endgenerate//}
  ...
  // NTUST CUSTOM DOT START
  // if any value in rd_match_a* is one, then oitfrd_match_dispa* is one.
  assign oitfrd_match_dispa0  = |rd_match_a0;
  assign oitfrd_match_dispa1  = |rd_match_a1;
  assign oitfrd_match_dispa2  = |rd_match_a2;
  assign oitfrd_match_dispa3  = |rd_match_a3;
  assign oitfrd_match_dispa4  = |rd_match_a4;
  assign oitfrd_match_dispa5  = |rd_match_a5;
  assign oitfrd_match_dispa6  = |rd_match_a6;
  assign oitfrd_match_dispa7  = |rd_match_a7;
  // NTUST CUSTOM DOT END
